...
2. Explore promising lines as Threads.
3. Promote only consequential directions to Candidates.
4. Use Admission Review when the direction would create a project, change investment level, or cause a major pivot.
5. Accept Canon only after human confirmation and review evidence.
